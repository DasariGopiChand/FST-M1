...
public class Activity9 {
	...
	@Test
	public void NamesAndUsers () throws InterruptedException {
		...
		System.out.println("Sno. | Name            |  User");
		System.out.println("********************************");
		for (int i= 1 ; i<=10; i++) {
			System.out.print(i+" |    "+driver.findElement(By.xpath("//table[@class]/tbody/tr["+i+"]/td[3]//a")).getText()+" |   ");
			System.out.println(driver.findElement(By.xpath("//table[@class]/tbody/tr["+i+"]/td[8]//a")).getText());
